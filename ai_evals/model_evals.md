I actually think this is the right place to start because **every other evaluation type builds on model evaluation**. Once you understand what model evals measure, application, RAG, and agent evals become much easier to reason about.
